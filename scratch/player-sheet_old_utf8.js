...
import { renderPCSpells } from './player/PCSpellsTab.js';
import { renderPCFeatures } from './player/PCFeaturesTab.js';
...
function renderPlayerTabBar(pc) {
  ...
  const spellsTabHtml = isCaster ? `
    <button class="player-tab-btn ${activeTab === 'spells' ? 'active' : ''}" data-tab="spells">­ƒö« Zauberbuch</button>
  ` : '';

  container.innerHTML = `
    <button class="player-tab-btn ${activeTab === 'overview' ? 'active' : ''}" data-tab="overview">­ƒøí´©Å ├£bersicht</button>
    <button class="player-tab-btn ${activeTab === 'skills' ? 'active' : ''}" data-tab="skills">­ƒô£ Skills &amp; Talente</button>
    <button class="player-tab-btn ${activeTab === 'offense' ? 'active' : ''}" data-tab="offense">ÔÜö´©Å Ausr├╝stung</button>
    <button class="player-tab-btn ${activeTab === 'magicitems' ? 'active' : ''}" data-tab="magicitems">Ô£¿ Magische Gegenst├ñnde</button>
    ${spellsTabHtml}
    <button class="player-tab-btn ${activeTab === 'features' ? 'active' : ''}" data-tab="features">­ƒÉ¥ Klasse &amp; Begleiter</button>
    <button class="player-tab-btn" id="btnSystemMenuPlayer">ÔÜÖ´©Å System</button>
  `;
