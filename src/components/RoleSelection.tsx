...
export const RoleSelection: React.FC = () => {
  ...
  return (
    <div className="role-overlay" style={{ display: 'flex' }}>
      <div className="role-container">
        <div className="role-title">✦ Rolle wählen ✦</div>
        <div className="role-subtitle">Dungeons &amp; Dragons 3.5e · Kampf-Manager</div>
        
        <div className="role-grid">
          <div className="role-card" id="btnChooseDM" onClick={() => handleSelectRole('dm')}>
            <div className="role-icon">👁️‍🗨️</div>
