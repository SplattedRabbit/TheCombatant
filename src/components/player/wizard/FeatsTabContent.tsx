                  ...
                  >
                    <div style={{ display: 'flex', alignItems: 'center', gap: '6px', marginBottom: '2px' }}>
                      ...
                      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flex: 1 }}>
                        <strong style={{ fontSize: '11px', color: isBlocked ? 'var(--inkm)' : 'var(--red)' }}>{feat.name || feat.nameEn || feat.nameDe || feat.id}</strong>
                      </div>
                    </div>
                    
                    {parentFeat && !featSearch && (
                      <div style={{ fontSize: '8.5px', color: 'var(--inkm)', fontStyle: 'italic', marginBottom: '3px', paddingLeft: '16px' }}>
                        ↳ Requires: <strong>{parentFeat.name || parentFeat.nameEn || parentFeat.nameDe}</strong>
                      </div>
                    )}

                    <div style={{ fontSize: '10px', color: 'var(--ink)', fontFamily: 'var(--font-body)', lineHeight: 1.3, marginBottom: '3px', paddingLeft: '16px' }}>
                      {feat.benefit || feat.benefitRaw || feat.benefitDe || feat.description}
                    </div>
