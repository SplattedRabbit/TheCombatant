    ...
    <DialogOverlay onClose={onCancel} width={450} id="sampleChoiceDialogOverlay">
      ...
      {isPlayer ? (
        <>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
            ...
            >
              <strong style={{ fontSize: '11px', color: 'var(--red)', fontFamily: 'var(--font-title)' }}>🔮 Wizard (Elf, Level 10)</strong>
            ...
            <button 
              ...
              style={{ display: 'flex', flexDirection: 'column', padding: '6px 12px', textAlign: 'left', cursor: 'pointer', background: 'rgba(200,169,110,0.06)', border: '0.5px solid var(--pb)', borderRadius: '3px' }}
            >
              <strong style={{ fontSize: '11px', color: 'var(--red)', fontFamily: 'var(--font-title)' }}>🏹 Ranger (Human, Level 10)</strong>
              <span style={{ fontSize: '9px', color: 'var(--inkm)', fontFamily: 'var(--font-body)', marginTop: '2px' }}>
            ...
            <button 
              ...
              style={{ display: 'flex', flexDirection: 'column', padding: '6px 12px', textAlign: 'left', cursor: 'pointer', background: 'rgba(200,169,110,0.06)', border: '0.5px solid var(--pb)', borderRadius: '3px' }}
            >
              <strong style={{ fontSize: '11px', color: 'var(--red)', fontFamily: 'var(--font-title)' }}>🛡️ Paladin (Human, Level 10)</strong>
              <span style={{ fontSize: '9px', color: 'var(--inkm)', fontFamily: 'var(--font-body)', marginTop: '2px' }}>
            ...
            <button
              ...
              style={{ display: 'flex', flexDirection: 'column', padding: '6px 12px', textAlign: 'left', cursor: 'pointer', background: 'rgba(200,169,110,0.06)', border: '0.5px solid var(--pb)', borderRadius: '3px' }}
            >
              <strong style={{ fontSize: '11px', color: 'var(--red)', fontFamily: 'var(--font-title)' }}>🗡️ Arcane Trickster (Human, Level 11)</strong>
              <span style={{ fontSize: '9px', color: 'var(--inkm)', fontFamily: 'var(--font-body)', marginTop: '2px' }}>
            ...
            <button
              ...
              style={{ display: 'flex', flexDirection: 'column', padding: '6px 12px', textAlign: 'left', cursor: 'pointer', background: 'rgba(200,169,110,0.06)', border: '0.5px solid var(--pb)', borderRadius: '3px' }}
            >
              <strong style={{ fontSize: '11px', color: 'var(--red)', fontFamily: 'var(--font-title)' }}>🎯 Spellwarp Sniper (Human, Level 10)</strong>
              <span style={{ fontSize: '9px', color: 'var(--inkm)', fontFamily: 'var(--font-body)', marginTop: '2px' }}>
        ...
        <>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
            ...
            <button 
              ...
              style={{ display: 'flex', flexDirection: 'column', padding: '6px 12px', textAlign: 'left', cursor: 'pointer', background: 'rgba(200,169,110,0.06)', border: '0.5px solid var(--pb)', borderRadius: '3px' }}
            >
              <strong style={{ fontSize: '11px', color: 'var(--red)', fontFamily: 'var(--font-title)' }}>🛡️ Aranis Only (Paladin Level 3)</strong>
              <span style={{ fontSize: '9px', color: 'var(--inkm)', fontFamily: 'var(--font-body)', marginTop: '2px' }}>
      ...
      <div style={{ marginTop: '16px', display: 'flex', justifyContent: 'center' }}>
        <button 
          onClick={onCancel}
          className="btn" 
          style={{ fontFamily: 'var(--font-title)', fontSize: '10px', padding: '5px 25px', cursor: 'pointer', background: 'transparent', border: '1px solid var(--pb)', color: 'var(--ink)' }}
        >
          Close
        </button>
      </div>
